...
async function runTests() {
  ...
  // Test 3: Session
  await test('Get Session', 'GET', `${baseUrl}/auth/session`);

  // Test 4: Get Tasbeeh Progress
  await test('Get Tasbeeh Progress', 'GET', `${baseUrl}/progress/tasbeeh`);

  // Test 5: Update Tasbeeh Progress
  await test(
    'Update Tasbeeh Progress',
    'PUT',
